...
if (customAmount.amount > user.balance){console.log(chalk.bgRedBright("Insufficient Balance!"));
}else {
    ...
    if (FastCash.amount > user.balance){console.log(chalk.bgRedBright("Insufficient Balance!"));
}else {
